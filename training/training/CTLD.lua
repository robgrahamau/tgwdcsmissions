...
ctld.pickupZones = {
    { "romefarp", "none", -1, "yes", 2,500 },
	{ "KobFarp", "none", -1, "yes", 2,501 },
    { "perth", "none", -1, "yes", 2, 502 },
...
ctld.logisticUnits = {
	...
	"perth",
    "farp ground crew-3",
	"farp ground crew-3-2",
	"KobFarp",
	"Static FARP Tent-12",
	"Static FARP Tent-12-1",
	"FARP1",
	"romefarp",
	"farp ground crew-2",
	"farp ground crew-2-1",
}
...
ctld.unitActions = {
	 ...
	 ["AH-64D_BLK_II"] = {crates = false, troops=false}
}
