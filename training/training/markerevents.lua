...
function hevent:OnEventLandingQualityMark(EventData) 
  ...
  lsomsg = 
  hm("**Training Server Super Carrier LSO** \n> ** " .. where .. "** \n> **Landing Grade for  " .. who .. " \n> **Aircraft Type:** " .. t .. " \n> **Grade:** " .. comment .. "." )
  hmlso( "**Training Server Super Carrier LSO** \n> ** " .. where .. "** \n> **Landing Grade for  " .. who .. " \n> **Aircraft Type:** " .. t .. " \n> **Grade:** " .. comment .. "."  )
end
...
function hevent:OnEventMarkRemoved(EventData)
    ...
    elseif EventData.text:lower():find("-rspawn") or EventData.text:lower():find("-rs") then
          if admin == true then
            newhandlespawn(text2,coord)
          else
            MESSAGE:New("Admin Commands need to be active to spawn new units",15):ToAll()
    ...
    elseif EventData.text:lower():find("-load") then
          if admin == true then
            dofile(lfs.writedir() .."training\\input.lua")
          else
